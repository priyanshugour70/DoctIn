<a name="br1"></a>**Synopsis Document for PBL**
...
**Vedant Chandekar Mrs. Laksita Mandpe**

**Enrollment No.: 22BCA3CCM10042 Assistant Professor, SSOCA**

**Priyanshu Gour**

**Enrollment No.: 22BCA3CCM10029**
...
<a name="br3"></a>**Statement about the Problem**
...
<a name="br4"></a>**Why is the Particular topic chosen**
...
<a name="br5"></a>**Objective and Scope**
...
<a name="br6"></a>Scope: The scope of the proposed healthcare software project is vast, and it covers several
...
<a name="br8"></a>Another important consideration is the need for healthcare leaders and policy makers to
...
<a name="br9"></a>**Hardware & Software**
...
<a name="br10"></a>**What contribution would the project make ?**

Our project is centered around two primary areas of focus - the Frontend and Backend.

For the Frontend, we have decided to use a combination of HTML, CSS, JavaScript, ReactJs and
NextJs. These tools are essential for creating a visually stunning and responsive website that is
both user-friendly and engaging. To design the website, we have opted for Whimsical and Figma,
which are excellent tools for creating wireframes and prototypes. Once the design is finalized,
Visual Studio Code Editor is used to write all code. This IDE is popular among developers due to
its ease of use and extensive features.

On the other hand, for the Backend, we are using Rest APIs, Springboot, Advanced Java, and
MySql. These technologies are essential for building a robust and scalable backend system that
can handle large amounts of data. Eclipse is the preferred IDE for writing the entire codebase.
Eclipse is a powerful tool that offers a wide range of features that make it an excellent choice for
enterprise-level applications.

In terms of data storage, we have decided to use MySql. MySql is a popular open-source database
management system that is widely used in web applications. It offers excellent performance,
scalability, and reliability, making it an ideal choice for our project.

Overall, our project is designed to be a robust and scalable web application that offers an excellent
user experience. By using the right tools and technologies, we are confident that we can deliver a
high-quality product that meets the needs of our users.




<a name="br11"></a>**The Schedule of the project (Gantt chart / PERT chart)**




<a name="br12"></a>**References / Bibliography**

• [https://dev.java/learn/getting-started/ ](https://dev.java/learn/getting-started/)• <https://nextjs.org/docs/getting-started>

• [https://legacy.reactjs.org/docs/getting-started.html
](https://legacy.reactjs.org/docs/getting-started.html)• [https://docs.spring.io/spring-boot/docs/current/reference/htmlsingle/
](https://docs.spring.io/spring-boot/docs/current/reference/htmlsingle/)• [https://www.figma.com/best-practices/guide-to-developer-handoff/components-styles-
](https://www.figma.com/best-practices/guide-to-developer-handoff/components-styles-and-documentation/)[ ](https://www.figma.com/best-practices/guide-to-developer-handoff/components-styles-and-documentation/)[and-documentation/](https://www.figma.com/best-practices/guide-to-developer-handoff/components-styles-and-documentation/)

• [https://developers.google.com/maps/documentation
](https://developers.google.com/maps/documentation)• [https://www.eclipse.org/documentation/
](https://www.eclipse.org/documentation/)• <https://dev.mysql.com/doc/>

• [https://stackoverflow.com/documentation ](https://stackoverflow.com/documentation)• <https://tailwindcss.com/docs/installation>
