...
export default function MediCarts2() {
  return (
    <div>
          ...
          <div className="block mb-2" href="#">
            <div className="relative overflow-hidden">
              <div className="mb-5 overflow-hidden">
                <img
                  className="object-cover w-full mx-auto transition-all rounded h-72 hover:scale-110"
                  src="https://i.postimg.cc/jj6c4Q8Q/green-front-sweater.jpg"
                  alt=""
                />
              </div>
              <svg
                ...
                height={28}
                fill="currentColor"
                className="absolute text-rose-500 top-3 right-3"
                viewBox="0 0 16 16"
              >
                <path
                  fillRule="evenodd"
          ...
          <div className="block mb-2" href="#">
            <div className="relative overflow-hidden">
              <div className="mb-5 overflow-hidden">
                <img
                  className="object-cover w-full mx-auto transition-all rounded h-72 hover:scale-110"
                  src="https://i.postimg.cc/mgyVQyp3/black-front-sweater.jpg"
                  alt=""
                />
              </div>
              <svg
